...
// MFC200511_2Set.cpp : CMFC200511_2Set 类的实现
//
...
// 代码生成在 2020年5月11日, 15:55

IMPLEMENT_DYNAMIC(CMFC200511_2Set, CRecordset)

CMFC200511_2Set::CMFC200511_2Set(CDatabase* pdb)
	: CRecordset(pdb)
{
	column1 = L"";
	column2 = 0.0;
...
// 储为其他格式或使用其他的用户身份验证。
CString CMFC200511_2Set::GetDefaultConnect()
{
...
CString CMFC200511_2Set::GetDefaultSQL()
{
	return _T("[Sheet1$]");
}

void CMFC200511_2Set::DoFieldExchange(CFieldExchange* pFX)
{
...
#ifdef _DEBUG
void CMFC200511_2Set::AssertValid() const
{
	CRecordset::AssertValid();
}

void CMFC200511_2Set::Dump(CDumpContext& dc) const
{
	CRecordset::Dump(dc);
}
#endif //_DEBUG
